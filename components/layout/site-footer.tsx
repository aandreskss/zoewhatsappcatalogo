        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8">
          ...
          <div>
            ...
            <p className="text-sm text-[var(--color-muted-foreground)] leading-relaxed max-w-xs">
              Calzado para toda la familia: damas, caballeros, deportivo y escolar. Mayor y detal en Valencia, Venezuela. 20 años de trayectoria.
            </p>
            <a
              href={`https://wa.me/${whatsappNumber}`}
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 mt-6 text-sm font-semibold text-[var(--color-primary)] hover:text-[#A3305E] transition-colors"
            >
      ...
      <div className="border-t border-[var(--color-border)]">
        <div className="mx-auto max-w-[1440px] px-6 md:px-12 py-5">
          <p className="text-xs text-[var(--color-muted-foreground)]">
            © {new Date().getFullYear()} Zoe Shop · Valencia, Venezuela
          </p>
        </div>
      </div>
    </footer>
